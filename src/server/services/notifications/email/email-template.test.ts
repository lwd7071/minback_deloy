...
describe("email templates", () => {
  ...
  it("renders evaluation returned email with correct content and privacy guarantees", () => {
    ...
    expect(result.htmlContent).toContain("https://minback.edu.vn/class/SE101/login");
  ...
  it("renders test email correctly", () => {
    ...
    expect(result.htmlContent).toContain("Cấu hình Brevo của MinBack đang hoạt động");
  });
});
