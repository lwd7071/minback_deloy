...
const challengeKey = (studentId: string, purpose: ChallengePurpose) =>
  `${purpose}:${studentId}`;
...
export const createForgotPinChallenge = (studentId: string) =>
  createChallenge(studentId, "forgot_pin");
export const createEmailChangeChallenge = (studentId: string) =>
  createChallenge(studentId, "change_email");
...
export async function verifyChallenge(
  ...
  valid: boolean;
  reason?: "EXPIRED" | "TOO_MANY_ATTEMPTS" | "INVALID_OTP" | "NOT_FOUND";
}> {
  cleanupExpired();
...
export const verifyForgotPinOtp = (studentId: string, inputOtp: string) =>
  verifyChallenge(studentId, inputOtp, "forgot_pin");
export const verifyEmailChangeOtp = (studentId: string, inputOtp: string) =>
  verifyChallenge(studentId, inputOtp, "change_email");
